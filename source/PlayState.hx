	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'eddhouse':
				...
				BF_X = cooljson.positions.norski_song.bf.x;
				BF_Y = cooljson.positions.norski_song.bf.y;
				GF_X = cooljson.positions.norski_song.gf.x;
				GF_Y = cooljson.positions.norski_song.gf.y;
				DAD_X = cooljson.positions.norski_song.tord.x;
				DAD_Y = cooljson.positions.norski_song.tord.y;
		}
		...
		if(PlayState.SONG.song.toLowerCase() != "norski"){
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'norski':
					...
					var coolIntroduction:FlxSprite;
					coolIntroduction = new FlxSprite(0, 0).loadGraphic(Paths.image('tord/deez_nuts', 'shared'));
					coolIntroduction.scrollFactor.set();
					defaultCamZoom = 1.05;
					camHUD.visible = false;
					add(coolIntroduction);
					new FlxTimer().start(4, function(tmr:FlxTimer){
						remove(coolIntroduction);
						camHUD.visible = true;
						defaultCamZoom = cooljson.positions.norski_song.zoom.cool_zoom;
