...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch(PlayState.SONG.song.toLowerCase()){
			...
			case 'norski':
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('tord/dialogue/tord_dialogue');
			portraitLeft.animation.addByPrefix('normal', 'tordDialog', 24);
			portraitLeft.animation.addByPrefix('angry', 'tordPissedDialog', 24);
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
			add(portraitLeft);
			portraitLeft.visible = false;
			...
			portraitRight = new FlxSprite(0, 40);
			portraitRight.frames = Paths.getSparrowAtlas('tord/dialogue/bf_dialogue');
			portraitRight.animation.addByPrefix('normal', 'bfDialog', 24);
			portraitRight.updateHitbox();
			portraitRight.scrollFactor.set();
			add(portraitRight);
			portraitRight.visible = false;
